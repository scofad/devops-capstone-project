...
![Build Status](https://github.com/scofad/devops-capstone-project/actions/workflows/ci-build.yaml/badge.svg)
[![License](https://img.shields.io/badge/License-Apache%202.0-blue.svg)](https://opensource.org/licenses/Apache-2.0)
[![Python 3.9](https://img.shields.io/badge/Python-3.9-green.svg)](https://shields.io/)

This project is part of the DevOps Capstone. It implements a Customer Accounts microservice
using Flask and RESTful APIs, following Agile planning, Test Driven Development (TDD),
CI/CD pipelines, containerization, and Kubernetes deployment.
